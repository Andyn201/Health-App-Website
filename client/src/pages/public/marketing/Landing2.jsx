  ...
  return (
        ...
        <section style={{width: "100%", height: "40vh", backgroundColor: "#FBFCFE"}} className="section">
            <div className="container">
                <div className="row center valign-wrapper">
                    <div className="col s12">
                        <h3>Want Us To Set Up An AI Chatbot For You Free?</h3>
        ...
        <section id="call" style={{width: "100%"}} className="section center">
            <div className="container">
                <div className="row center valign-wrapper">
                    <div className="col s12">
                        <h3 style={{fontSize: "5rem"}}>Want Us To Build You A <span className='orange-text lighten-1'>Chatbot</span> For Free?</h3>
                    </div>  
                </div>
            </div>
            <InlineWidget url="https://calendly.com/seryph-766/free-chatbot?primary_color=6d00ff" />
        </section>

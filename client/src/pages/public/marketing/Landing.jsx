  ...
  return (
                ...
                <div className='container'>
                    <div className="row center">
                        <div className="col s12">
                            <h1 style={{fontSize: "5.5rem"}}>How <span style={{color: "#0FB8CE"}}>AI</span> Can Help <br />Your Company </h1>
        ...
        <section style={{width: "100%", height: "40vh", backgroundColor: "#FBFCFE"}} className="section">
            <div className="container">
                <div className="row center valign-wrapper">
                    <div className="col s12">
                        <h3 style={{fontSize: "3.5rem"}}>Want Us To Build You An AI Chatbot Free? { /* Curious About AI's Role In Your Company? */}</h3>
                        <br />
        ...
        <section style={{width: "100%"}} className="section black white-text">
            ...
            <div className="row row-1">
                ...
                <div className="img-content">
                    <h3>AI For Lead Generation{/* Data Analysis */}</h3>
                    <p>
                        {/*
                        Curious about certain trends that impact your company. 
                        AI can be used for predictions and forecasting, from sales 
                        cycles to CO2 levels.  */}
                        Use AI to get new leads for your company and take care of your onboarding. 
                        An AI Chatbot can personalize your sales process so people of all different
                        backgrounds and wants can learn about your company.
                    </p>   
                    <br />
        ...
        <section id="call" style={{width: "100%"}} className="section center">
            <div className="container">
                <div className="row center valign-wrapper">
                    <div className="col s12">
                        <h3 style={{fontSize: "5rem"}}>Get A Free {/*Ask Us How*/ }<span className='orange-text lighten-1'>{/*AI */}Chatbot</span> To Help Your Company</h3>
                    </div>  
                </div>
            </div>
            <InlineWidget url="https://calendly.com/seryph-766/free-chatbot?primary_color=4514e0" />
        </section>
